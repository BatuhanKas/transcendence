 ...
 */
var iterables = require('mnemonist/utils/iterables.js'),
    typed = require('mnemonist/utils/typed-arrays.js'),
    inplaceQuickSortIndices = require('mnemonist/sort/quick.js').inplaceQuickSortIndices,
    lowerBoundIndices = require('mnemonist/utils/binary-search.js').lowerBoundIndices,
    Heap = require('mnemonist/heap.js');
