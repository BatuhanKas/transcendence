...
} = require('fastify/lib/hooks')

const internals = require('fastify/lib/handleRequest')[Symbol.for('internals')]
const loggerUtils = require('fastify/lib/logger-factory')
const now = loggerUtils.now
const { handleError } = require('fastify/lib/error-handler')
const { getSchemaSerializer } = require('fastify/lib/schemas')
...
const decorators = require('fastify/lib/decorate')
