...
const { kState, kOptions, kServerBindings } = require('fastify/lib/symbols')
const { FSTWRN003 } = require('fastify/lib/warnings')
const { onListenHookRunner } = require('fastify/lib/hooks')
const {
