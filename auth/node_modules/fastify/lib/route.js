...
const Context = require('fastify/lib/context')
const handleRequest = require('fastify/lib/handleRequest')
const { onRequestAbortHookRunner, lifecycleHooks, preParsingHookRunner, onTimeoutHookRunner, onRequestHookRunner } = require('fastify/lib/hooks')
const { normalizeSchema } = require('fastify/lib/schemas')
const { parseHeadOnSendHandlers } = require('fastify/lib/headRoute')

const {
  compileSchemasForValidation,
  compileSchemasForSerialization
} = require('fastify/lib/validation')
...
const { buildErrorHandler } = require('fastify/lib/error-handler')
const { createChildLogger } = require('fastify/lib/logger-factory.js')
const { getGenReqId } = require('fastify/lib/reqIdGenFactory.js')
