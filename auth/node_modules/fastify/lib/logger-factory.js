 ...
 * @param {string} reqId
 * @param {import('fastify/types/logger.d.ts').ChildLoggerOptions?} loggerOpts
 *
 ...
 *
 * @param {import('fastify').FastifyBaseLogger} logger
 * @param {import('fastify/types/logger.d.ts').Bindings} bindings
 * @param {import('fastify/types/logger.d.ts').ChildLoggerOptions} opts
 *
 * @returns {import('fastify/types/logger.d.ts').FastifyBaseLogger}
 */
...
function createLogger (options) {
  ...
  const { createPinoLogger, serializers } = require('fastify/lib/logger-pino.js')
