...
const helper = require('fastify/test/helper')
const { FST_ERR_LOG_INVALID_LOGGER } = require('fastify/lib/errors')
const { once, on } = stream
const { createTempFile, request } = require('fastify/test/logger/logger-test-utils')
const { partialDeepStrictEqual } = require('fastify/test/toolkit')
