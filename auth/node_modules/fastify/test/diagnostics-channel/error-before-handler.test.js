...
require('fastify/lib/hooks').onSendHookRunner = function Stub () {}
const Request = require('fastify/lib/request')
const Reply = require('fastify/lib/reply')
const symbols = require('fastify/lib/symbols.js')
const { preHandlerCallback } = require('fastify/lib/handleRequest')[Symbol.for('internals')]
