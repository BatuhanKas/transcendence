...
const { waitForCb } = require('fastify/test/toolkit')

test('require a plugin', (t, testDone) => {
  t.plan(1)
  const fastify = Fastify()
  fastify.register(require('fastify/test/plugin.helper'))
  fastify.ready(() => {
...
test('plugin metadata - naming plugins', async t => {
  ...
  fastify.register(require('fastify/test/plugin.name.display'))
