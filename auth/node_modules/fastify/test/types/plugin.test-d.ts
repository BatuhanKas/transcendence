...
import { FastifyPluginCallback, FastifyPluginAsync } from 'fastify/types/plugin'
...
expectAssignable<FastifyInstance>(fastify().register(import('fastify/test/types/dummy-plugin')))
expectAssignable<FastifyInstance>(fastify().register(import('fastify/test/types/dummy-plugin'), { foo: 1 }))
