...
const {
  ...
  kChildLoggerFactory,
  kGenReqId
} = require('fastify/lib/symbols.js')

const { createServer } = require('fastify/lib/server')
const Reply = require('fastify/lib/reply')
const Request = require('fastify/lib/request')
const Context = require('fastify/lib/context.js')
const decorator = require('fastify/lib/decorate')
const ContentTypeParser = require('fastify/lib/contentTypeParser')
const SchemaController = require('fastify/lib/schema-controller')
const { Hooks, hookRunnerApplication, supportedHooks } = require('fastify/lib/hooks')
const { createChildLogger, defaultChildLoggerFactory, createLogger } = require('fastify/lib/logger-factory')
const pluginUtils = require('fastify/lib/pluginUtils')
const { getGenReqId, reqIdGenFactory } = require('fastify/lib/reqIdGenFactory')
const { buildRouting, validateBodyLimitOption } = require('fastify/lib/route')
const build404 = require('fastify/lib/fourOhFour')
const getSecuredInitialConfig = require('fastify/lib/initialConfigValidation')
const override = require('fastify/lib/pluginOverride')
const noopSet = require('fastify/lib/noop-set')
const {
  appendStackTrace,
  AVVIO_ERRORS_MAP,
  ...errorCodes
} = require('fastify/lib/errors')
...
const { buildErrorHandler } = require('fastify/lib/error-handler.js')
